...
export class AboutComponent {
  ...
  aboutParagraphs: string[] = [
    "The Punjab Water Regulation and Development Authority (PWRDA) constituted under the Punjab Water Resources Regulation and Management Act, 2020 is mandated to regulate the water resources of the state for ensuring its judicious, equitable and sustainable utilisation and management.",
