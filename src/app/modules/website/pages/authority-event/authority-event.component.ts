...
export class AuthorityEventComponent {
  ...
  eventDetails = {
    ...
    description: 'The Punjab Water Regulation and Development Authority (SDSO), Chandigarh, had organized the World Water Day on 27th March 2026. Total 550+ participants has take part in the event. Some glimpse of the event are:',
